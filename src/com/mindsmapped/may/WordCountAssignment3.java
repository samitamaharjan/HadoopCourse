...
enum User_Defined_Counter {
	REJECTED_WORD, WORD_COUNT;
}

public class WordCountAssignment3 {
	...
	public static class Map extends
		...
		public void map(LongWritable key, Text value, Context context)
			...
			while (itr.hasMoreTokens()) {
				...
				if(word.equals("is")){
					break;
					//context.getCounter(User_Defined_Counter.REJECTED_WORD).increment(1);
				}
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.addInputPath(job, new Path("/home/cloudera/wordcount/text_isRepeated.txt"));
		// set the HDFS path for the output
		//FileOutputFormat.setOutputPath(job, new Path(otherArgs[1]));
		FileOutputFormat.setOutputPath(job, new Path("/home/cloudera/wordcount/output_rejectedWord"));
